...
<? if ($num_speakers != '') { ?>
<h2>Test case results for parameter translation from uri to internal names</h2>
...
<h2>Putting it all together enables the following functions</h2>
<h3>Generating a URI to reload the current page, recycles controller and action from the request object (internally)</h3>
<?=$uf_view->lpm_uri(array('num-speakers' => 15,'muu' => 'baaar'))?>
<h3>Generating a URI to reload the current page, recycles controller and action from the request object (internally), overriding language to swedish (be in english mode to see it)</h3>
<?=$uf_view->lpm_uri(array('num-speakers' => 15,'muu' => 'baaar'),'sv-se')?>

<h3>Generating a fresh URI to another controller/action/parameter(s)</h3>
<?=$uf_view->cap('examples','debug')?>
<h3>Generating a fresh URI to another controller/action/parameter(s), overriding language to swedish (be in english mode to see it)</h3>
<?=$uf_view->cap('examples','debug','','sv-se')?>
